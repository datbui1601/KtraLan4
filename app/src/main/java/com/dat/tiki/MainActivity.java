...
public class MainActivity extends AppCompatActivity {
    ...
    private List<GridViewBean> getListData() {
        ...
        GridViewBean gridViewBean1 =new GridViewBean(R.drawable.loa,"Loa JBL chống nước","đ20.000.000đ");
        GridViewBean gridViewBean3 =new GridViewBean(R.drawable.loa2,"Loa Sanco 4","đ20.000.000");
        GridViewBean gridViewBean4 =new GridViewBean(R.drawable.oppo,"Loa JPL","đ7.000.000đ");
        GridViewBean gridViewBean5 =new GridViewBean(R.drawable.loa3,"Loa tiktiti","đ20.000.000đ");
        GridViewBean gridViewBean6 =new GridViewBean(R.drawable.loa4,"Loa JBL đứng ","đ4.000.000đ");
